...
export const SpecialOffersStyled = styled.section`
  // margin: auto;
  display: flex;
  ...
  background-color: ${COLORS.colorSpecOffSectionBg};
  ${desktop`
    margin-top: 20px;
  `}
  ${tablet`
...
${mobile`
  ...
  article {
    ...
    border-radius: 15px;
    max-width: 1300px;
    box-shadow: 0px 5px 7px ${COLORS.colorSpecOffShadow};
    // border: solid rgb(36, 36, 36) 1px;
    border: solid ${COLORS.colorSpecOffBorder} 1px;
    background-color: ${COLORS.colorSpecOffArticleBg};
    color: ${COLORS.colorSpecOffText};
  ...
  .artTitle {
    ...
    // padding-left: 15px;
    // height: 90px;
    color: ${COLORS.colorSpecOffTitle};
  ...
  h2 {
    ...
    text-decoration-color: ${COLORS.colorSpecOffUnderline};
    margin-left: 15px;
    /* margin-bottom: 15px; */
    ${mobile`
      margin-left: 0px;
